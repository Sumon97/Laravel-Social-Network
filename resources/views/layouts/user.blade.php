...
<link href="{{ asset('css/gallery.css') }}" rel="stylesheet">
  ...
  <link rel="icon" type="image/png" href="../../assets/img/courier.jpg">
...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <nav
  class="navbar navbar-expand-lg navbar-light bg-light py-4">
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navigation">
      <ul class="navbar-nav navbar-nav-hover ms-12">
        <div class="row">
        ...
        <div class="col-auto m-auto">
          ...
          <div class="col-auto m-auto">
            <div class="dropdown">
              <a class="cursor-pointer" href="/friend" >
                Friends
              </a>
              <ul class="dropdown-menu dropdown-menu-right px-2 py-3 ms-n4" aria-labelledby="dropdownMenuButton">
                ...
